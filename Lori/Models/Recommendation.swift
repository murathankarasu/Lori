...
struct RecommendedItem: Codable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, content, emotion, emotionAnalysis, interests, likes, tags, timestamp, userId, username, comments, commentsCount, keywords
        case createdAt = "created_at" // JSON'daki key ile eşleştirme
        case isAd = "is_ad"
        case adMetadata = "ad_metadata"
    }
...
struct AdMetadata: Codable, Equatable, Hashable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case priority
        case targetEmotions = "target_emotions"
    }
