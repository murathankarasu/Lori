...
struct SignUpView: View {
    ...
    private func getStatusMessage() -> String {
        if containsInappropriateContent {
            if let category = inappropriateCategory {
                return "This username contains inappropriate content: \(category)"
            }
    ...
    private func checkUsername(_ username: String) {
        ...
        if username.contains(" ") {
            ...
            inappropriateCategory = "Spaces are not allowed"
    ...
    private func signUp() {
        ...
        guard !containsInappropriateContent else {
            if let category = inappropriateCategory {
                alertMessage = "This username contains inappropriate content: \(category)"
            } else {
                alertMessage = "This username contains inappropriate content."
            }
            showAlert = true
            return
        }
