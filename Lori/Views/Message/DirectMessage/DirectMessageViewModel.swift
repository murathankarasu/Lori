...
class DirectMessageViewModel: ObservableObject {
    ...
    func loadConversations() async {
        ...
        do {
            ...
            self.errorMessage = "Messages cannot load: \(error.localizedDescription)"
            self.isLoading = false
        }
    }
    ...
    func loadMessages(for conversationId: String) async {
        ...
        do {
            ...
            self.errorMessage = "Messages cannot loading: \(error.localizedDescription)"
            self.isLoading = false
        }
    }
    ...
    func sendMessage(to conversationId: String, receiverId: String) async {
        ...
        do {
            ...
            self.errorMessage = "Message cannot sent: \(error.localizedDescription)"
