...
struct GaladrielFactCheckView: View {
    ...
    private func extractExplanation(from explanation: String) -> String {
        // Attempt to clean up headers if they exist
        let cleanText = explanation
            .replacingOccurrences(of: "✅ Content Verified", with: "")
            .replacingOccurrences(of: "❌ False Information", with: "")
            .replacingOccurrences(of: "⚠️ Partially True", with: "")
            .replacingOccurrences(of: "🔍 Insufficient Information", with: "")
            .replacingOccurrences(of: "🤔 Unverifiable/Personal Opinion", with: "")
